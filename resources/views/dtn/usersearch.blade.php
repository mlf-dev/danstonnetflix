                ...
                @else
                    ...
                    <div class="row justify-content-center">
                        <h5>En ce moment :
                            ...
                            <a href="@if($user->enCeMoment->isMovie){{route('movie',['id'=>$serie_du_moment->id_tmdb])}} @else {{route('tv',['id'=>$user->enCeMoment->id_tmdb])}} @endif">{{$serie_du_moment->name}}</a>
                            @else
                                <p>Ne regarde rien en ce moment.</p>
                            @endif</h5>
                    </div>
                    <div class="row justify-content-center">
                        <div class="btn-group mb-3">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{route('addfriend',['second_user'=>$user->id])}}">Ajouter à mes amis</a>
                            </div>
                        </div>
                    </div>
