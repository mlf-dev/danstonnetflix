        ...
        <div class="row justify-content-around">
            <div class="flex-column col-md-4 background-dark-opactiy show-tv-item justify-content-center">
                ...
                @else
                    ...
                    <div class="row justify-content-center">
                        <h5>En ce moment : <a href="@if($user->enCeMoment->isMovie == true){{route('movie',['id'=>$serie_du_moment->id_tmdb])}} @else {{route('tv',['id'=>$user->enCeMoment->id_tmdb])}} @endif">{{$serie_du_moment->name}}</a></h5>
                    </div>
                    <div class="row justify-content-center">
                        <div class="btn-group mb-3">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="#">Ajouter à mes amis</a>
                            </div>
                        </div>
                    </div>
